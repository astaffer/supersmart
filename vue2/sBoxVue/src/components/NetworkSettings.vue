  ...
  <md-card md-with-hover class="settings">
    ...
    <md-switch v-model="dhcp" id="dhcp-switch" name="dhcp-switch" class="md-primary">DHCP</md-switch>
      <md-input-container v-bind:class="{ 'md-input-invalid': wrongip}">
        ...
        <md-input type="text" v-model="ip" v-mask="'###.###.###.###'"  >{{ ip }}</md-input>
        <span class="md-error">Validation message</span>
      </md-input-container>
      <md-input-container >
        <label>Маска подсети</label>
        <md-input type="text" v-model="mask" v-mask="'###.###.###.###'">{{ mask }}</md-input>
      </md-input-container>
      <md-input-container >
        <label>Основной шлюз</label>
        <md-input type="text" v-model="gateway" v-mask="'###.###.###.###'">{{ gateway }}</md-input>
      </md-input-container>
      <md-input-container >
        <label>DNS-сервер</label>
        <md-input type="text" v-model="dns" v-mask="'###.###.###.###'"> {{ dns }}</md-input>
      </md-input-container>
